...
//		startIntentService();
	...
	public  void disableShiftMode(AHBottomNavigation view) {
		AHBottomNavigation menuView = (AHBottomNavigation) view.getChildAt(0);
		try {
...
//				AHBottomNavigationItem item = (AHBottomNavigationItem) menuView.getChildAt(i);
